...
Getting started
You can quickly and easily open a GitHub repository either by searching for Remote Repositories: Open Remote Repository... from the Command Palette (press F1), or by choosing Open Remote Repository... from the remote indicator (the green button in the lower left corner of the status bar).
...
Opening the VS Code repo remotely
...
Telemetry
The GitHub Repositories extension collects telemetry data to help us build a better experience working remotely from VS Code. The extension respects the telemetry.enableTelemetry setting which you can learn more about in the Visual Studio Code FAQ.
